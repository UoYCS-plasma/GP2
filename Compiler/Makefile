...
RULEOBJECTS = Main_deleteBase.o Main_nonempty.o Main_par.o Main_seq.o
ROBJECTS = debug.o error.o runtime.o init_runtime.o match.o label.o graph.o rule.o stack.o $(RULEOBJECTS)

RULEHEADERS = Main_r1.h Main_r2.h DeleteNode_r1.h Main_deleteBase.h Main_nonempty.h Main_par.h Main_seq.h
...
all:	
		make compile && ./GP2-compile $(F1) $(F2) && make run && ./GP2-run

debug:		
		make compile-debug $(F1) $(F2) && make run-debug
...
Main_par.o:	Main_par.c Main_par.h graph.h macros.h match.h stack.h
		$(CC) $(CFLAGS) -c Main_par.c 

Main_seq.o:	Main_seq.c Main_seq.h graph.h macros.h match.h stack.h
		$(CC) $(CFLAGS) -c Main_seq.c 

Main_deleteBase.o:	Main_deleteBase.c Main_deleteBase.h graph.h macros.h match.h stack.h
			$(CC) $(CFLAGS) -c Main_deleteBase.c 

Main_nonempty.o:	Main_nonempty.c Main_nonempty.h graph.h macros.h match.h stack.h
			$(CC) $(CFLAGS) -c Main_nonempty.c 
