...
/* emitEdgeFromNodeMatcher emits a function corresponding to the searchplan 
 * operations 's', 't' and 'l', those that match an edge from an incident
 * matched node. 
 *
 * Argument 1: The LHS edge that is matched by the generated function.
 * Argument 2: The type of the operation ('s', 't' or 'l').
 * Argument 3: The next operation in the searchplan. NULL if this is the
 *             last operation. */
